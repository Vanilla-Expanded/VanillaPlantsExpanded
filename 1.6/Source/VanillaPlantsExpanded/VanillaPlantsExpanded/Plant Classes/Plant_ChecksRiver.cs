    ...
    public class Plant_ChecksRiver : Plant
    {
        ...
        public override float GrowthRate
        {
            get
            {
                ...
                return this.GrowthRateFactor_Fertility * this.GrowthRateFactor_Temperature * this.GrowthRateFactor_Light * this.GrowthRateFactor_River * GrowthRateFactor_NoxiousHaze * GrowthRateFactor_Drought; ;
            }
        }
