...
{
    public class Plant_WinterResistant : Plant
    {
        ...
        public override float GrowthRate
        {
            get
            {
                ...
                return this.GrowthRateFactor_Fertility * this.GrowthRateFactor_TemperatureCold * this.GrowthRateFactor_Light * GrowthRateFactor_NoxiousHaze * GrowthRateFactor_Drought; ;
            }
        }

        public float GrowthRateFactor_TemperatureCold
        {
            get
            {
                float num;
                ...
                if (num < 10f)
                {
                    return Mathf.InverseLerp(-5f, 10f, num);
                }
                if (num > 42f)
                {
        ...
        public override string GetInspectString()
        {
            ...
            if (this.LifeStage == PlantLifeStage.Growing)
            {
                ...
                if (!this.Blighted)
                {
                    ...
                    float growthRateFactor_Temperature = this.GrowthRateFactor_TemperatureCold;
